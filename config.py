...
INDUSTRY = os.getenv("INDUSTRY", "retail_data")
...
# ── RETAIL COLUMN SETTINGS ────────────────────────────────────────
# Categorical columns to group by in group_analysis()
GROUP_COLS = ["product_category", "customer_segment"]

# Primary numeric metric for group analysis and anomaly detection
VALUE_COL = "total_amount"

# Column to check for anomalies
ANOMALY_COL = "total_amount"

# Numeric columns to include in correlation analysis (excludes IDs)
CORR_COLS = ["total_amount", "product_price", "rating"]
